...
mod tests {
    ...
    /// The mirror of the case above: with no resolved DTLS role there is no correct parity,
    /// so the channel is created without a stream id and waits for the connected procedure
    /// rather than being dialed or rejected.
    #[test]
