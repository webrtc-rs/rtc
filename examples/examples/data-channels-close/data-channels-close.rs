...
#[derive(Parser)]
#[command(name = "data-channels-close")]
#[command(author = "Rusty Rain <y@liu.mx>")]
#[command(version = "0.0.0")]
#[command(about = "An example of Data-Channels-Close", long_about = None)]
struct Cli {
    #[arg(short, long)]
    client: bool,
    #[arg(short, long)]
...
async fn main() -> Result<()> {
    ...
    let close_after = cli.close_after;
...
async fn run(
    ...
    let send_interval = Duration::from_secs(5);
