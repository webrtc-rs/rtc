...
the bandwidth estimation in `chrome://webrtc-internals`. It is under `VideoBwe` when
`Read Stats From: Legacy non-Standard`
is selected.
...
[jsfiddle.net](https://jsfiddle.net/1ksh29cv/3/) you should see two text-areas and a 'Start Session' button.
